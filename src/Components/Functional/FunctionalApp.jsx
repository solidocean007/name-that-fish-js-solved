...
export function FunctionalApp({ initialFishes }) {
  ...
  const [score, setScore]= useState({  // Create score state which is an object of 2 different counts.
    correctCount: 0,
    incorrectCount: 0,
  })
  ...
  const handleScore = (userGuess, fishName) => { // This is called on the users input form on FunctionalGameBoard.
  ...
  return (
    <>
      ...
      {!gameEnd && <FunctionalGameBoard fish={ fish } handleScore={handleScore}/>}
